  ...
  <div class="carousel-inner rounded-3 shadow">
    <div class="carousel-item active">
      ...
      <div class="carousel-caption d-none d-md-block">
        <h5>Atención Médica</h5><p>Gestión de doctores, pacientes y citas</p>
      </div>
    </div>
    ...
    <div class="carousel-item">
      ...
      <div class="carousel-caption d-none d-md-block">
        <h5>Profesionales</h5><p>Equipo médico especializado</p>
      </div>
    </div>
    ...
    <div class="carousel-item">
      ...
      <div class="carousel-caption d-none d-md-block">
        <h5>Infraestructura</h5><p>Instalaciones modernas y seguras</p>
      </div>
    </div>
    ...
    <div class="carousel-item">
      ...
      <div class="carousel-caption d-none d-md-block">
        <h5>Diagnóstico</h5><p>Imagenología de alta precisión</p>
      </div>
    </div>
    ...
    <div class="carousel-item">
      ...
      <div class="carousel-caption d-none d-md-block">
        <h5>Laboratorio</h5><p>Resultados confiables y oportunos</p>
      </div>
    </div>
    ...
    <div class="carousel-item">
      ...
      <div class="carousel-caption d-none d-md-block">
        <h5>Cirugía</h5><p>Protocolos con estándares internacionales</p>
      </div>
    </div>
    ...
    <div class="carousel-item">
      ...
      <div class="carousel-caption d-none d-md-block">
        <h5>Telemedicina</h5><p>Atención donde estés</p>
      </div>
    </div>
    ...
    <div class="carousel-item">
      ...
      <div class="carousel-caption d-none d-md-block">
        <h5>Emergencias</h5><p>Respuesta rápida y efectiva</p>
      </div>
    </div>
  </div>
